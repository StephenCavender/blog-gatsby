...
const Card = ({ link, title, thumbnail, date, dateModified, excerpt }) => {
  return (
    <>
      <div className="rounded border border-slate-500 bg-slate-200 shadow-lg transition-all duration-500 ease-in-out hover:-translate-y-2 hover:shadow-slate-400">
